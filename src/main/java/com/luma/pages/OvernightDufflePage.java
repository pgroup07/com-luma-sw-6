...
public class OvernightDufflePage extends Utility {
    ...
    WebElement toShoppingCartAddedMessage;
    ...
    public String shoppingCartAddedMessage() throws InterruptedException {
        log.info("Get added to cart message : " + toShoppingCartAddedMessage.toString());
        Thread.sleep(1000);
        return getTextFromElement(toShoppingCartAddedMessage);
    }
